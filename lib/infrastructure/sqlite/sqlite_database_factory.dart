...
import 'package:accountant_manager/infrastructure/sqlite/adapters/database_sqlite_adapter.dart';
import 'package:accountant_manager/infrastructure/sqlite/migrations/create_table_money_account_migration.dart';
import 'package:accountant_manager/infrastructure/sqlite/migrations/create_table_money_transaction_migration.dart';
import 'package:sqflite/sqflite.dart';

final List<DatabaseMigrationPort<Database>> migrations = [
  CreateTableMoneyAccountMigration(),
  CreateTableMoneyTransactionMigration()
];
